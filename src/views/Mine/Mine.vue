    ...
    <div class="my">
        ...
        <ul class="my-order-tab">
         ...
         <div class="margin-set"
            ...
            >
            <div class="left">
                <img :src="nav.left_img" alt="">
                <span>{{nav.txt}}</span>
            </div>
            <div class="right">
                <div class="price-fmt">
                    <span style="font-size:11px;">{{nav.span1}}</span>
                    <span style="font-size:15px;">{{nav.span2}}</span>
                </div>
                <img :src="nav.right_img" alt="">
            </div>
        </div>
        <Tabbar></Tabbar>
    </div>
